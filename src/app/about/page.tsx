  ...
  return (
    <div className="container py-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Про проєкт "Тренажери Швидкочитання"</h1>
        
        <div className="prose prose-lg">
          <p>
            Проєкт "Тренажери Швидкочитання" - це колекція інтерактивних тренажерів, 
          ...
          <ul>
            <li>
              <strong>Тренажер "Крокодил"</strong> - тренажер для швидкісного читання, для розвитку лінійного читання.
            </li>
            <li>
              <strong>Тренажер "Широкого погляду"</strong> - тренажер для тренування считувати цілі слова та словосполучення.
            </li>
            <li>
              <strong>Таблиці Шульте</strong> - тренажер для розвитку периферійного зору та концентрації уваги.
            </li>
            <li>
              <strong>Тренажер "Око в центрі"</strong> - тренажер для покращення швидкості читання за допомогою різних технік вертикального читання.
            </li>
          </ul>
          ...
          <p>
            ...
            сторінці та натисніть кнопку "Запустити". Кожен тренажер має свої 
